...
$glossaries['es_AR'] = go_download_glotdict('es_AR', "https://translate.wordpress.org/locale/es-ar/default/glossary");
$glossaries['es_ES'] = go_download_glotdict('es_ES', "https://translate.wordpress.org/locale/es/default/glossary");
$glossaries['es_MX'] = go_download_glotdict('es_MX', "https://translate.wordpress.org/locale/es-mx/default/glossary");
$glossaries['es_VE'] = go_download_glotdict('es_VE', "https://translate.wordpress.org/locale/es-ve/default/glossary");
$glossaries['el']    = go_download_glotdict('el',    "https://translate.wordpress.org/locale/el/default/glossary");
$glossaries['eu']    = go_download_glotdict('eu',    "https://translate.wordpress.org/locale/eu/default/glossary");
...
$glossaries['fr_CA'] = go_download_glotdict('fr_CA', "https://translate.wordpress.org/locale/fr-ca/default/glossary");
$glossaries['gl_ES']    = go_download_glotdict('gu',    "https://translate.wordpress.org/locale/gl/default/glossary");
...
$glossaries['hu_HU'] = go_download_glotdict('hu_HU', "https://translate.wordpress.org/locale/hu/default/glossary");
$glossaries['it_IT'] = go_download_glotdict('it_IT', "https://translate.wordpress.org/locale/it/default/glossary");
$glossaries['id']    = go_download_glotdict('id', "https://translate.wordpress.org/locale/id/default/glossary");
$glossaries['ja']    = go_download_glotdict('ja',    "https://translate.wordpress.org/locale/ja/default/glossary");
$glossaries['ko_KR'] = go_download_glotdict('ja',    "https://translate.wordpress.org/locale/ko/default/glossary/");
...
$glossaries['mr']    = go_download_glotdict('mr', "https://translate.wordpress.org/locale/mr/default/glossary");
...
$glossaries['pt']    = go_download_glotdict('pt',    "https://translate.wordpress.org/locale/pt/default/glossary");
...
$glossaries['te']    = go_download_glotdict('te',    "https://translate.wordpress.org/locale/te/default/glossary");
...
function go_download_glotdict($locale, $url, $do_encode=false) {
    ...
    if ( $file !== false ) {
        ...
        foreach ( $lines as $csv ) {
            ...
            $values[3] = $values_[3];
            if($do_encode) {
                $values[1] = utf8_encode($values[1]);
                $values[2] = utf8_encode($values[2]);
                $values[3] = utf8_encode($values[3]);
            }
        ...
        if($old_json !== $output) {
            ...
            if(empty($json_output)) {
                mail("mte90net@gmail.com", "Wrong GlotDict Glossary Generation for ".$locale, "Wrong GlotDict Glossary Generation for ".$locale);
            }
            file_put_contents( $path . $locale . ".json" , $json_output );
            $time = @date('d/m/Y');
        }
